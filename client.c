...
//     printf("Request sent to Storage Server to stream: %s\n", buffer);
...
//         if (strcmp(command, "LIST") == 0 || strcmp(command, "CREATE_DIC") == 0 || strcmp(command, "CREATE_F") == 0 || strcmp(command, "DELETE") == 0)
//         {
//             continue;
//         }
